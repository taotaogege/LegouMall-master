    ...
    private void initView() {
        ...
        settleChooseRv.setAdapter(new CommonAdapter<Rshopcar>(this, R.layout.settle_choose_lv_item, mPchoose) {
            ...
            protected void convert(ViewHolder holder, Rshopcar rshopcar, int position) {
                Glide.with(DingDanActivity.this)
            ...
            if (rOrderParams.errorType == 1) {
                ...
                ((Button) view.findViewById(R.id.sure_btn)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        start2Activity(DingDanActivity.this, OrderListActivity.class, true);
                    }
                });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_submitClick:
                final SAddOrderParams params = new SAddOrderParams();
                if (mAddressId == 0) {
                    tip("请填写正确的收货地址");
                    return;
                }
                ...
                params.payWay = payOnlineTv.isSelected() ? 1 : 0;
//                Log.i("++payOnlineTv++", "onViewClicked: "+payOnlineTv.isSelected());
//                Log.i("++payWhengetTv++", "onViewClicked: "+payWhengetTv.isSelected());
                if(payOnlineTv.isSelected() == false && payWhengetTv.isSelected() == false){
                    tip("请选择支付方式");
                }else{
